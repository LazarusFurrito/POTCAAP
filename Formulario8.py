    ...
    def guardar_registro(self, datos_paciente):
        ...
        try:
            with self.connection.cursor() as cursor:
                # SQL para insertar el registro - MySQL manejará la fecha automáticamente
                sql = """
                INSERT INTO pacientes (
                    id_registro, nombres, apellidos, altura, peso, 
                    temperatura, cintura, cadera, presion_arterial
                ...
                cursor.execute(sql, (
                    ...
                    datos_paciente['height'],
                    datos_paciente['weight'],
                    datos_paciente['temperature'],
                    datos_paciente['waist'],
                    datos_paciente['hip'],
                    datos_paciente['presion']
                ))
        ...
        try:
            with self.connection.cursor() as cursor:
                ...
                UPDATE pacientes SET 
                    ...
                    temperatura = %s, cintura = %s, cadera = %s, presion_arterial = %s
                WHERE id_registro = %s
                """
                ...
                cursor.execute(sql, (
                    ...
                    datos_actualizados['height'],
                    datos_actualizados['weight'],
                    datos_actualizados['temperature'],
                    datos_actualizados['waist'],
                    datos_actualizados['hip'],
                    datos_actualizados['presion'],
                    id_registro
                ))
...
class GestorArchivos:
    ...
    def listar_registros(self):
        ...
        try:
            ...
            # Convertir a formato similar al anterior para compatibilidad
            archivos = [f"{r['nombres']}_{r['apellidos']}_{r['id_registro']}" for r in registros]
            return archivos
        except Exception as e:
            print(f"Error al listar registros: {e}")
            return []
...
class FormularioSecuencial(QDialog):
    ...
    def finalizar_formulario(self):
        ...
        if campos_faltantes:
            ...
            return  # Este return solo se ejecuta si hay campos faltantes
